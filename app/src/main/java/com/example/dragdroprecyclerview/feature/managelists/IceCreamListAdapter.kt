package com.example.dragdroprecyclerview.feature.managelists
 ...
 */
class IceCreamListAdapter(dataSet: List<IceCream> = emptyList()) : DragDropSwipeAdapter<IceCream, IceCreamListAdapter.ViewHolder>(dataSet) {
    ...
    override fun onIsDragging(item: IceCream?, viewHolder: ViewHolder, offsetX: Int, offsetY: Int, canvasUnder: Canvas?, canvasOver: Canvas?, isUserControlled: Boolean) {
    ...
    override fun onIsSwiping(item: IceCream?, viewHolder: ViewHolder, offsetX: Int, offsetY: Int, canvasUnder: Canvas?, canvasOver: Canvas?, isUserControlled: Boolean) {
        // Call commented out to avoid saturating the log

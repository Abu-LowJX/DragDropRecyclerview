package com.example.dragdroprecyclerview.feature.managelists.view.base
...
import com.example.dragdroprecyclerview.R
import com.example.dragdroprecyclerview.config.local.ListFragmentType
import com.example.dragdroprecyclerview.config.local.currentListFragmentConfig
import com.example.dragdroprecyclerview.config.local.currentListFragmentType
import com.example.dragdroprecyclerview.data.model.IceCream
import com.example.dragdroprecyclerview.data.source.base.BaseRepository
import com.example.dragdroprecyclerview.feature.managelists.IceCreamListAdapter
import com.example.dragdroprecyclerview.feature.managelists.view.GridListFragment
import com.example.dragdroprecyclerview.feature.managelists.view.HorizontalListFragment
import com.example.dragdroprecyclerview.feature.managelists.view.VerticalListFragment
import com.example.dragdroprecyclerview.util.Logger
...
abstract class BaseListFragment : Fragment() {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            R.id.change_item_layout -> currentListFragmentConfig.isUsingStandardItemLayout = !currentListFragmentConfig.isUsingStandardItemLayout
            R.id.change_dragging_restrictions -> currentListFragmentConfig.isRestrictingDraggingDirections = !currentListFragmentConfig.isRestrictingDraggingDirections
            R.id.enable_disable_drawing_behind -> currentListFragmentConfig.isDrawingBehindSwipedItems = !currentListFragmentConfig.isDrawingBehindSwipedItems
            R.id.enable_disable_fade_on_swiping -> currentListFragmentConfig.isUsingFadeOnSwipedItems = !currentListFragmentConfig.isUsingFadeOnSwipedItems
        }
